                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-9">
                            <div class="row g-4 justify-content-center">
                                ...
                                $query = "SELECT m.*, c.cate_title FROM menu as m  INNER JOIN categories as c ON m.cate_id = c.cate_id WHERE c.cate_id = $the_cate_id ";
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                    ...
                                                    <div class="d-flex justify-content-between flex-lg-wrap">
                                                        ...
                                                        <a href="./cart.php?p_id=<?php echo $drinks_id ?> " class="btn border border-secondary rounded-pill px-3 text-primary" name="add-to-cart"><i class="fa fa-shopping-bag me-2 text-primary"></i>Add to cart</a>
